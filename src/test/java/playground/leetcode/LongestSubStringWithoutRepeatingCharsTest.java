...
public class LongestSubStringWithoutRepeatingCharsTest {
    @Test
    public void findLongestSubStringWithoutRepeatingCharsTest() {
        ...
        var outcome = testCases.stream()
                .map(pair -> Pair.of(pair.getLeft(),
                        LongestSubStringWithoutRepeatingChars.findLongestSubStringWithoutRepeatingCharsTest(pair.getRight())))
                .toList();

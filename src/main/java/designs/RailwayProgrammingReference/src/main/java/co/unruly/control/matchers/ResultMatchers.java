...
public class ResultMatchers {
     ...
     */
    @Contract("_ -> new")
    public static <S, F> @NotNull Matcher<Result<S, F>> isSuccessOf(S expectedValue) {
     ...
     */
    @Contract("_ -> new")
    public static <S, F> @NotNull Matcher<Result<S, F>> isSuccessThat(Matcher<S> expectedSuccess) {
     ...
     */
    @Contract("_ -> new")
    public static <S, F> @NotNull Matcher<Result<S, F>> isFailureOf(F expectedValue) {
     ...
     */
    @Contract("_ -> new")
    public static <S, F> @NotNull Matcher<Result<S, F>> isFailureThat(Matcher<F> expectedFailure) {
